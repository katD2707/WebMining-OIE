...
def process(source_file, rel_file, target_file, pretrained_model):
    ...
    write_dataset_to_file(train_set, "relation_model_data_linking/train.json")
    write_dataset_to_file(dev_set, "relation_model_data_linking/devs.json")
    write_dataset_to_file(test_set, "relation_model_data_linking/test.json")
